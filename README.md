This code is for parameter optimization of three parameters in a NB detection method. The code looks for the best parameter combination across 50x50x50 combinations through a grid search.
